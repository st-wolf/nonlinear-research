...
tspan = [0 T_fin]; S0 = [Sz0; Sx0; Sy0]; N = 2^14;
...
% Legend
legend( ...
	sprintf('\\kappa = %g, \\lambda = %g, \\Lambda = %g', kappa, lambda_1, Lambda_1), ...
...
V = @(x) new_alpha * (R^2) * ( ((1/4) * (Lambda_2 ^ 2) - lambda_2 * (1 - lambda_2)) * (sn(x, lambda_2) .^ 2) ...
...
alpha = 1; beta = 0.9; B = 1; R = 1; kappa = 0.004; T_fin = 300; t_new_regime = 200;
