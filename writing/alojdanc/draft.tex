...
%
\begin{figure}[Ht!]
\center{\includegraphics[width=0.5\linewidth]{pic/potential_and_modes.eps}}
...
Период потенциалов $V(x)$ равен $4K(\lambda)$, где $K(\lambda)$ -- полный эллиптический интеграл первого рода.
Характеристики double-well ловушки: ловушка существует при $0 < \Lambda < 2*\lambda$; $V(0) = -\Lambda$; 
...
%
\begin{figure}[Ht!]
\center{\includegraphics[width=0.5\linewidth]{pic/V_Fock.eps}}
...
%
\begin{figure}[Ht!]
\center{\includegraphics[width=1\linewidth]{pic/tau_on_E_Rabi.eps}}
