...
%
\begin{figure}[ht]
\center{\includegraphics[width=\linewidth]{pic/action_period_1st_order_transition.eps}}
\caption{1st-order transition, $\lambda = 0.9$, $\Lambda = 0.1$}
\end{figure}
%
\begin{figure}[ht]
\center{\includegraphics[width=\linewidth]{pic/action_period_2nd_order_transition.eps}}
