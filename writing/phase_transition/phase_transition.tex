...
%
\begin{figure}[ht]
\center{\includegraphics[width=0.5\linewidth]{pic/ypm_x0.eps}}
...
%\begin{figure}[ht]
%\begin{minipage}[h]{0.49\linewidth}
%\center{\includegraphics[width=\linewidth]{pic/action_period_2nd_order_transition_b2.eps} \\ (a)}
%\end{minipage}
%\hfill
%\begin{minipage}[h]{0.49\linewidth}
%\center{\includegraphics[width=\linewidth]{pic/phase_transition_temperatures_b2.eps} \\ (b)}
%\end{minipage}
...
%
\begin{figure}[ht]
\center{\includegraphics[width=0.7\linewidth]{pic/phase_potential_dissipation.eps}}
...
Otherwise, after some time interval dissipation leads to crossover in the phase dynamics and destroy the W--potential as whole, see Fig. \ref{pic:phase}.
